    ...
    <div class="container-fluid py-5" style="background-color: #f5f5f5">
      <div style="background-color: #ffffff" class="p-5 m-auto signup-form">
        ...
        <form class="mt-3" @submit.prevent="register">
          <div class="row">
            <div class="col-md-6"><!-- Firstname --><base-input 
            type="text"
            identity="firstname"
            placeholder="Ex: Jack"
            label="Firstname"
            ...
            ></base-input></div>
            <div class="col-md-6"><!-- Lastname --><base-input 
            type="text"
            identity="lastname"
          ...
          <div class="my-4"><!-- Username --><base-input 
            type="text"
            identity="username"
            placeholder="Mika Waiswana"
            label="Username"
          ...
          <div class="my-4"><!-- Email --><base-input 
            type="email"
            identity="email"
            placeholder="mikawaiswana0332@gmail.com"
            label="Email"
          ...
          <div class="my-4"><!-- Confirm Password --><base-input 
            type="password"
          ...
          <div class="my-4"><!-- Profile Photo --><base-input 
            type="file" 
          ...
          <base-button
          class="login w-100 my-3 btn btn-register rounded-pill">Register
          </base-button>
        </form>
        <div class="text-center mt-4">
          <p class="fw-semibold">
            Already have account?<router-link
            to="/login" style="color: #4c4ddc"  class="text-decoration-none"
